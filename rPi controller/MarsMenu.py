...
class MarsMenu:
    ...
    def _build_menu_items(self):
        ...
        self._items[MenuCategory.SAFETY] = [
            ...
            MenuItem("---Collision Model---", "info", value=""),
            MenuItem("Col Enabled", "option", value=1, options=["Off", "On"]),
            MenuItem("Col Stop", "option", value=1, options=["Off", "On"]),
            MenuItem("Col WarnOnly", "option", value=0, options=["Off", "On"]),
            MenuItem("Leg Radius", "value", value=15.0, min_val=0.0, max_val=100.0, step=0.5, unit="mm",
                     format_func=lambda v: f"{float(v):.1f}mm"),
            MenuItem("Safety Margin", "value", value=5.0, min_val=0.0, max_val=100.0, step=0.5, unit="mm",
                     format_func=lambda v: f"{float(v):.1f}mm"),
            MenuItem("Body Keepout", "value", value=50.0, min_val=0.0, max_val=200.0, step=5.0, unit="mm",
                     format_func=lambda v: f"{float(v):.0f}mm"),
            MenuItem("Vel Horizon", "value", value=50, min_val=0, max_val=250, step=5, unit="ms",
                     format_func=lambda v: f"{int(v)}ms"),
            MenuItem("Vel Margin Max", "value", value=20.0, min_val=0.0, max_val=80.0, step=1.0, unit="mm",
                     format_func=lambda v: f"{float(v):.0f}mm"),

                # Diagnostics
                MenuItem("Pose Log", "option", value=0, options=["Off", "On"]),
                MenuItem("Pose Log Hz", "value", value=10, min_val=1, max_val=60, step=1, unit="Hz"),
        ...
        self._items[MenuCategory.SYSTEM] = [
            ...
            MenuItem("Col Overlay", "option", value=0, options=["Off", "On"]),
